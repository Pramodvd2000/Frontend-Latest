...
const UserDropdown = () => {
  ...
  return (
    <UncontrolledDropdown tag='li' className='dropdown-user nav-item'>
      ...
      <div className='user-nav d-sm-flex d-none' style={{ alignItems: 'center' }}>

{/* <p style={{fontWeight:'bold', alignContent:'center'}}>V.2.0.7</p> */}
<p style={{ fontWeight: 'bold', marginRight: '10px', marginBottom: '0' }}>V.2.0.7</p>
