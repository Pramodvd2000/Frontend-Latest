...
{reload && <Col md="3" sm="12">
       ...
       <div className='d-flex justify-content-between'>
          ...
          <Button className='me-1' color='primary' type='submit' disabled = {isValidating} onClick={()=>setflag(false)}>
          Save And Next
          </Button>
          <Button className="me-1" color="primary" type='submit' disabled = {isValidating} onClick={()=>setflag(true)}>
          Create Guest
          </Button>
