...
const WizardModern = () => {
  ...
  const [columnDefs] = useState([
    ...
    { headerName: 'Email ID', field: 'e', suppressSizeToFit: true, width: 220,cellStyle: { textAlign: "center", backgroundColor: "#F1E39B" } },
    { headerName: 'No. Stays', field: 'stays', suppressSizeToFit: true, width: 120,cellStyle: { textAlign: "center", backgroundColor: "pink" } },
    { headerName: 'No. Nights', field: 'nights', suppressSizeToFit: true, width: 120,cellStyle: { textAlign: "center", backgroundColor: "#F1E39B" } },
    {headerName: "Action",field: "numAvlRooms", suppressSizeToFit: true, maxWidth: 140,cellRendererFramework: (params) => (
        ...
        {
          cellRendererFramework: (params) => <Button color='primary' onClick={() => {setOpenGuestHistory(params.data),console.log(params)}}> Past History </Button>,
                  ...
                  <div className="mb-1">
                    ...
                    <UncontrolledAccordion defaultOpen='1'>
                      ...
                      <Col>
                         ...
                         <Col>
                          <h6>Membership Type: {filldata.membershipDetails ? filldata.membershipDetails.membershipType : ' '}</h6>
                        </Col>           
                         <Col>
                           <h6>Membership Number: {filldata.membershipDetails ? filldata.membershipDetails.membershipNo : ' '}</h6>
                          </Col>
                          <Col>
                            <h6>Membership Level: {filldata.membershipDetails ? filldata.membershipDetails.membershipLevel : ' '}</h6>
                          </Col>
                         ...
                         <Row>
                         <Col>
                          <h6>Membership Since: {filldata.membershipDetails ? filldata.membershipDetails.membershipSince : ' '}</h6>
                        </Col>
                        <Col>
                          <h6>Membership Expiry: {filldata.membershipDetails ? filldata.membershipDetails.expiryDate : ' '}</h6>
                        </Col>
                        <Col></Col>
