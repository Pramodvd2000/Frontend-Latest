...
const WizardModern = () => {
  ...
  const [columnDefs, setColumnDefs] = useState([
   // {headerName: 'ID',field: 'id',suppressSizeToFit: true,maxWidth: 160},
    ...
    {headerName: 'Description',field: 'description',suppressSizeToFit: true,cellStyle: {'textAlign': 'center','backgroundColor': 'pink'}, width: 300 },
    {headerName: 'Group',field: 'groupCode',suppressSizeToFit: true,cellStyle: {'textAlign': 'center','backgroundColor': '#F1E39B'}, maxWidth: 140 },
    {headerName: 'Sub Group',field: 'subGroup',suppressSizeToFit: true,cellStyle: {'textAlign': 'center','backgroundColor': 'pink'}, maxWidth: 200 },
    ...
    // {headerName: 'isActive',field: 'isActive'},
    {
      ...
      cellRendererFramework: (params) => (
        <Button color="primary" onClick={() => {setfilldata(params.data)
          console.log(params.data)
          actionButton(!show)}}> View  </Button> ),
    },
  ]);
