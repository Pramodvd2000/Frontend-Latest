...
const EditAccountMap = ({ stepper, rateCodeId, initialData }) => {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      // For example:
      // await updateAccountMappings(mappedAccounts)
      MySwal.fire({
        text: 'Account mappings updated successfully!',
        icon: 'success',
      ...
      MySwal.fire({
        text: 'Failed to update account mappings',
        icon: 'error',
        buttonsStyling: false,
        confirmButtonText: 'Close',
        customClass: {
    ...
    if (selectedAccount) {
      fetch(`${API_URL}/deleteAccontRateCodeMap`, {
        ...
        .then(() => {
          ...
          MySwal.fire({
            text: 'Mapped Account Removed Successfully!',
            icon: 'success',
            buttonsStyling: false,
            confirmButtonText: 'Close',
            customClass: {
  ...
  <div className="d-flex gap-2">
    {/* Uncomment the button below if you need an Update button */}
    {/* <Button 
      color="primary" 
      className="me-1" 
