...
const ExtrasMap = ({ stepper, rateCodeId }) => {
  // ** States
  ...
  return (
    <Fragment>
      ...
      <Modal isOpen={showRemoveModal} toggle={() => setShowRemoveModal(!showRemoveModal)} className="modal-sm">
        <ModalHeader toggle={() => setShowRemoveModal(!showRemoveModal)}>Need To Check..</ModalHeader>
      ...
      <div className='d-flex justify-content-between mt-2'>
        ...
        <Button type='submit' color='success' className='btn-submit' onClick={handleFormSubmit}>
          Submit
        </Button>
      </div>
    </Fragment>
