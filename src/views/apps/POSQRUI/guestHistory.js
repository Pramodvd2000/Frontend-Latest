...
const PreviewviewOrderpage = ({previeworder,handleclosevisitRecords,previewdata}) => {
...
<span  style={{ fontWeight: 'bold', fontSize: '1.2rem', display: 'flex', alignItems: 'center' }} onClick={() => handleclosevisitRecords()}>
      <FaArrowLeft style={{ marginRight: '5px' }} /> Previous Visits
    </span>
