...
const PreviewviewOrderpageconfirmed = ({previeworder,handleCloseViewOrderClick,previewdata}) => {
  // console.log("previewdata in preview ordering page")
...
<span  style={{ fontWeight: 'bold', fontSize: '1.2rem', display: 'flex', alignItems: 'center' }} onClick={() => handleCloseViewOrderClick()}>
      <FaArrowLeft style={{ marginRight: '5px' }} /> Confirmed Orders
    </span>
...
export default PreviewviewOrderpageconfirmed;
