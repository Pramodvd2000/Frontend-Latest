...
const SidebarAddPayment = ({ open, toggleSidebar, data }) => {
  ...
  const onSubmit = (formdata) => {
    ...
    //       console.log(err.message);
    //     });
    fetchx(API_URL+'/getBillDetails?hotelID=1&storeID='+localStorage.getItem('storeID')+'&orderID='+localStorage.getItem('orderID')+'&billNo='+localStorage.getItem('BillNo'))
    .then(result => result.json())
    .then(resp => {
      // console.log(resp['data'])
      setData(resp['data'][0])
...
// {console.log(data)}
  ...
  useEffect(() => {
    ...
    //     console.log(err.message);
    //   });
    // console.log('hotelID=1&storeID='+localStorage.getItem('storeID')+'&orderID='+localStorage.getItem('orderID')+'&billNo='+localStorage.getItem('BillNo'))
    fetchx(API_URL+'/getBillDetails?hotelID=1&storeID='+localStorage.getItem('storeID')+'&orderID='+localStorage.getItem('orderID')+'&billNo='+localStorage.getItem('BillNo'))
    .then(result => result.json())
    .then(resp => {
      // console.log(resp['data'])
