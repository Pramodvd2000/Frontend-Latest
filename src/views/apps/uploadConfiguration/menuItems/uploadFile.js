...
const UploadCSV = () => {
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        const response = await fetchx(API_URL2 + '/uploadMenuItems', {
          method: 'POST',
          body: formData,
        });
  ...
  <Row>
    ...
    <Col>
      <Button outline color='secondary' onClick={handleDownload}>Block File</Button>
    </Col>
  </Row>
</Col> */}
    <Col md='3' sm='12'>
...
{ <Button className='me-1' outline color='secondary' onClick={() => handleDownload('Menuitems.csv')}>MenuItems File</Button> }
        ...
        {/* <Button className='me-1' outline color='secondary'  onClick={handleDownload}> MenuItems File</Button> */}
        {/* <Button className='me-1' color='primary' type='submit'> Upload</Button> */}
      {/* </div>  */}
</Col>
          {/* </Row> */}
