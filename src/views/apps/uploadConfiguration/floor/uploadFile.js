...
const UploadCSV = () => {
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        const response = await fetchx(API_URL2 + '/uploadFloor', {
          method: 'POST',
          body: formData,
        });
        ...
        if (response.ok) {
          ...
          fetchx(API_URL2 + "/getFloor?hotelID=1")
     ...
     try {
      ...
      <div>
        ...
        <Col md='3' sm='12'>
          ...
          <Button className='me-1' outline color='secondary' onClick={() => handleDownload('floor.csv')}>Floor File</Button>
