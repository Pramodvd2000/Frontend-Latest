  ...
  const onSubmit = (data) => {
    ...
    setData(data);
      let createmarketGroup = JSON.stringify({
        "id": data1.id,
        "membershipType": data.membershipType1,
        "description":  data.description1,
     
          }); 
      let columnsToUpdate = createmarketGroup
      let res = fetchx(API_URL2 + `/updatemembershiptype?id=${data1.id}`,
        {
          method: "PUT",
        ...
        .then((resp) => {
            ...
            const swalInstance = MySwal.fire({
             text: 'Membership Type Details Updated Successfully!',
             icon: 'success',
         ...
         swalInstance.then((result) => {
           if (result.isConfirmed) {      
            ...
            const swalInstance = MySwal.fire({
                text: 'Membership Type Details Not Updated!',
                icon: 'error',
                buttonsStyling: false,
                confirmButtonText: 'Close',
                customClass: {
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Col md="3" sm="12">
                <div className="mb-1">
                  ...
                  <Controller
                    defaultValue={data1["membershipType"]}
                    control={control}
                    id="membershipType1"
                    ...
                    render={({ field }) => (
                      <Input
                        required
                        placeholder="Name"
                        invalid={errors.membershipType1 && true}
                        {...field}
                      />
                    )}
                  />
