...
const ReservationGroup = () => {
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    {headerName: 'Cost Center',field: 'costCenter',suppressSizeToFit: true , cellStyle: { 'text-align': 'center', 'background-color': '#F1E39B' }},
...
useEffect(() => {
  ...
  const onSubmit = data => {
    ...
    if (data.groupCode!== null && data.description !== null && data.costCenter !== null ) {
        ...
        let res = fetchx(API_URL2 + "/addgroup", {
          method: "POST",
          headers: { 'Content-Type': 'application/json' },
...
{hotelLive === 0 && (<Card>
      <CardHeader><h4><b> Add Groups</b></h4></CardHeader>
     </Card>)}
      {hotelLive === 0 && ( <p style={{color: "grey"}}> 
      <b><h4> Instructions:  </h4> </b>
      1.Please refer to the sample file before uploading the data. You can access the sample file by clicking the  <b>"group File" </b> button. Please ensure that data insertion follows the established pattern.<br/> Kindly refrain from altering the file structure.<br/>
 ...
 Cancel
    ...
    {hotelLive === 1 &&(<Accordion open={open} toggle={toggle}>
      <AccordionItem>
        <AccordionHeader targetId='1'><h4><b>Add Revenue Group </b> </h4></AccordionHeader>
      ...
      <CardBody>
        ...
        <div className='mb-1'>
          ...
          { console.log('Tax Amt:', taxValue)}

          <Col md='4' sm='12'>
          <div className='mb-1'>
            <Label className='form-label' for='costCenter'>
            Cost Center <spam style={{color:'red'}}>*</spam>
            </Label>
            <InputGroup className='input-group-merge'>
              ...
              <Controller
                ...
                render={({ field }) => (
                  ...
                  required={!taxValue || taxValue !== 'payment'}
