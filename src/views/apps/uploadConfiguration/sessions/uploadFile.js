...
const UploadCSV = () => {
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        const response = await fetchx(API_URL2 + '/uploadSessions', {
          method: 'POST',
          body: formData,
        });
...
<Button className='me-1' outline color='secondary' onClick={() => handleDownload('Session.csv')}>Session File</Button>        {/* <Button className='me-1' color='primary' type='submit'> Upload</Button> */}
      {/* </div>  */}
</Col>
          {/* </Row> */}
          </Row>
