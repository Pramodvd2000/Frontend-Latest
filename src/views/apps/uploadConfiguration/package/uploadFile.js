...
const UploadCSV = () => {
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        const response = await fetchx(API_URL2 + '/uploadPackage', {
          method: 'POST',
          body: formData,
        });
     ...
     const handleDownload = async (filename) => {
      ...
      <div>
        ...
        <Col md='3' sm='12'>
          ...
          <Button className='me-1' outline color='secondary' onClick={() => handleDownload('package.csv')}>Package File</Button>
