...
const UploadCSV = () => {
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        const response = await fetchx(API_URL2 + '/uploadPreferenceGroup', {
          method: 'POST',
          body: formData,
        });
    ...
    try {
      ...
      <div>
        ...
        <Col md='3' sm='12'>
          ...
          <Button className='me-1' outline color='secondary' onClick={() => handleDownload('reservationPreferenceGroup.csv')}>Preference Group File</Button>

          {/* <Button color='secondary' tag={Link} to='/apps/configuration/Sample Excel Sheet/block.csv' target='_blank' block outline className='mb-75'>Sample File</Button> */}
