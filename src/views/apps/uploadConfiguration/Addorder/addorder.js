...
let menuGroupOptions = [
    // fetchx(API_URL2+'/getmenugrouplist?hotelID=1&storeID=1')
...
let menuitemOptions = [
    //   fetchx(API_URL2+'/getmenuitemslist?menu=WINES')
    //   .then(result => result.json())
    //   .then(resp => {
...
//     fetchx(API_URL2 + '/getstewardlist?hotelID=1&storeID=1')
//         .then(result => result.json())
//         .then(resp => {
...
const ValidationThirdPartyComponents = ({getordersAmount}) => {
    ...
    useEffect(() => {
        fetchx(API_URL2 + '/getmenugrouplist?hotelID=1&storeID=' + localStorage.getItem('storeID'))
            .then(result => result.json())
            .then(resp => {
                menuGroupOptions = resp['data']
                setMgroupfetch(true)
    ...
    useEffect(() => {
        fetchx(API_URL2 + '/getstoremenuitems?hotelID=1&storeID=' + localStorage.getItem('storeID'))
            .then((result) => result.json())
            .then((rowData) => {
                //console.log(rowData);
    ...
    const handleOrderRowClick = () => {
        handleSubmit((data) => {
            ...
            let res = fetchx(API_URL2 + '/updateItemInstruction', {
                method: 'PUT',
                body: cartData,
                headers: {
                    'Content-type': 'application/json; charset=UTF-8',
        ...
        if (selectedItems) {
            ...
            fetchx(API_URL2 + '/additem', {
                ...
                .then((post) => {
                    ...
                    fetchx(API_URL2 + '/getTempItemList?hotelID=1&storeID=' + localStorage.getItem('storeID') + '&orderID=' + localStorage.getItem('orderID') + '&tableNo=' + localStorage.getItem('TableSelected'))
                        .then(result => result.json())
                        .then((resp) => {
    ...
    const handleCartClick = () => {
        handleSubmit((data) => {
            ...
            let res = fetchx(API_URL2 + '/addopenitem', {
                method: 'POST',
                body: cartData,
                headers: {
                    'Content-type': 'application/json; charset=UTF-8',
        ...
        fetchx(API_URL2 + '/voidKOT', {
            ...
            .then((post) => {
                if (post['statuscode'] == 200) {
                    ...
                    // voidkotModal
                    setvoidkotModal(false)
                    fetchx(API_URL2 + '/getPastKOT?hotelID=1&storeID=' + localStorage.getItem('storeID') + '&orderID=' + localStorage.getItem('orderID') + '&tableNo=' + localStorage.getItem('TableSelected'))
                        .then(result => result.json())
                        .then(resp => {
                            // console.log(resp['data']);
    ...
    const reprintSubmit = (data) => {
        ...
        fetchx(API_URL2 + '/reprintKOT?hotelID=1&storeID=' + localStorage.getItem('storeID') + '&orderID=' + localStorage.getItem('orderID') + '&tableNo=' + localStorage.getItem('TableSelected') + '&KOTno=' + sessionStorage.getItem('KOTNo') + '&reprintReason=' + data.reprintreason)
            .then(result => result.json())
            .then((post) => {
                if (post['statuscode'] == 200) {
    ...
    function handleClick(menu_group) {
        ...
        fetchx(API_URL2 + '/getmenuitemslist?hotelID=1&storeID=' + localStorage.getItem('storeID') + '&menuGroup=' + menu_group)
            .then(result => result.json())
            .then(resp => {
                // console.log(resp);
    ...
    function Addtocart() {
        ...
        // let itemstr = ""
        // let qtystr = ""
        // fetchx(API_URL2+'/getkotnumber?hotelID=1&storeID=1')
        //     .then(result => result.json())
        //     .then(resp => {
        //         // console.log(resp['data'])
    ...
    function handlemenulist(menu_item, list) {
        ...
        if (list[itemindex]['subItemStatus'] == 1) {
            ...
            fetchx(API_URL2 + '/getSubMenuItems?hotelID=1&storeID=' + localStorage.getItem('storeID') + '&itemID=' + list[itemindex]['itemID'])
                .then(result => result.json())
                .then(resp => {
                    //console.log(resp['data'])
    ...
    function CartTable() {
        ...
        const handleBreakCourseToggle = (index) => {
            ...
            fetchx(API_URL2 + '/addBreakCourse', {
                method: 'PUT',
                body: JSON.stringify({
