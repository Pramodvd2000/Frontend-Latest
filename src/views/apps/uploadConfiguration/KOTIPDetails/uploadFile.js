...
const UploadCSV = () => {
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        const response = await fetchx(API_URL2 + '/uploadKOTIPdetails', {
          method: 'POST',
          body: formData,
        });
...
<Button className='me-1' outline color='secondary' onClick={() => handleDownload('KitchenIPDetails.csv')}>KOT IP File</Button>        {/* <Button className='me-1' color='primary' type='submit'> Upload</Button> */}
      {/* </div>  */}
</Col>
