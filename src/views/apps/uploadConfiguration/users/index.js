  ...
  const onSubmit = data => {
    ...
    if (data.firstName !== null && data.lastName !== null && data.email !== null && data.password !== null && data.lastName !== null) {
      ...
      let createasset = JSON.stringify({
        ...
        "isAccountManager": data.accountManager,
        "isActive": data.activeStatus.value,
        "isStaff": data.staff.value,
        "isSuperUser": data.superUser.value,
      })
      console.log(createasset)
      let res = fetchx(API_URL2 + "/addUser", {
        method: "POST",
        ...
        <CardBody>
          <Form onSubmit={handleSubmit(onSubmit)}>
              ...
              <Label className='form-label' for='lastName'>
                lastName <spam style={{color:'red'}}>*</spam>
              </Label>              
                <Controller
                  id='lastName'
                  name='lastName'
              ...
              <Label className='form-label' for='password'>
                Password <spam style={{color:'red'}}>*</spam>
              </Label>              
                <Controller
                required
                  id='password'
              ...
              <Label className='form-label' for='department'>
                Department <spam style={{color:'red'}}>*</spam>
              </Label>
              <Controller
                id='department'
                control={control}
              ...
              <Label className='form-label' for='staff'>
                Staff <spam style={{color:'red'}}>*</spam>
              </Label>
              <Controller
                id='staff'
                control={control}
              ...
              <Label className='form-label' for='superUser'>
                Super User <spam style={{color:'red'}}>*</spam>
              </Label>
              <Controller
                id='superUser'
                control={control}
