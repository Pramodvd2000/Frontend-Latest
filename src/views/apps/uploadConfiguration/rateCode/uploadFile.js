...
const UploadCSV = () => {
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        const response = await fetchx(API_URL2 + '/uploadRateCode', {
          method: 'POST',
          body: formData,
        });
     ...
     try {
      ...
      <div>
        ...
        <Col md='3' sm='12'>
          ...
          <Button className='me-1' outline color='secondary' onClick={() => handleDownload('rateCode.csv')}>Rate Code File</Button>
