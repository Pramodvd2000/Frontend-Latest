...
import EditMarketGroup from "./editVip"
  ...
  const EditData = (rowData)=>{
    ...
    const onSubmit = data => {
        ...
        if (data.vipType.length && data.vipLevel.length) {
            ...
            let res = fetchx(API_URL2 + "/addvip", {
                method: "POST",
                headers: { 'Content-Type': 'application/json' },
                body: createvipType
            }).then(data => data.json())
                    ...
                    fetchx(API_URL2 + '/getvip?hotelID=1')
                        ...
                        .then(rowData => {
                            ...
                            const swalInstance = MySwal.fire({
                                text: 'VIP Details Added Successfully!',
                                icon: 'success',
            ...
            //             <h4>VIP Details Submitted Successfull</h4>
            //         </div>
            //     </div>
            // )
        }
...
<div>
      ...
      {hotelLive === 0 && (<Card>
      <CardHeader><h4><b> Add VIP</b></h4></CardHeader>
     </Card>)}
      {hotelLive === 0 && ( <p style={{color: "grey"}}> 
      <b><h4> Instructions:  </h4> </b>
      1.Please refer to the sample file before uploading the data. You can access the sample file by clicking the  <b>"VIP File" </b> button. Please ensure that data insertion follows the established pattern.<br/> Kindly refrain from altering the file structure.<br/>
                            ...
                            <Col md='4' sm='12'>
                                <div className='mb-1'>
                                    <Label className='form-label' for='vipType'>
                                        Vip Type  <spam style={{color:'red'}}>*</spam>
                                    </Label>
                                    <Controller
                                        defaultValue=''
                                        control={control}
                            ...
                            <Col md='4' sm='12'>
                                <div className='mb-1'>
                                    <Label className='form-label' for='vipLevel'>
                                        VIP Level  <spam style={{color:'red'}}>*</spam>
                                    </Label>
                                    <Controller
                                        defaultValue=''
                                        control={control}
