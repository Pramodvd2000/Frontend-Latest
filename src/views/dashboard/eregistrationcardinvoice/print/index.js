...
const RegistrationCard = () => {
  ...
  useEffect(() => {
    ...
    fetchx(API_URL + "/getReservationGuestDetails", {
      ...
      body: JSON.stringify({
        hotelID:'1',
        reservationID:localStorage.getItem('guestidDetail'),
        })
  ...
  return (
    ...
    <div style={{width:'210mm',paddingTop:'10px'}}>
                <tr>
                  ...
                  <font style={{ 'font-size': '12px', 'line-height': '100%' }}><b >{hotelName}</b></font>
        ...
        <div style={{paddingLeft:'10px', paddingRight:'5px'}}>
         <table  style={{border:'1px solid black','width':'202mm' ,height:'50mm',fontSize:'12px', color: 'black'}}>      
            <tr>
          ...
          <tr style={{borderBottom:'0.5px solid #575b63',height:'25px'}}>  
            <td style={{paddingLeft:'10px'}} colSpan={6}> <b>{details["IDType"]=== 'passport' ? details["idNumber"] : ''} </b></td>  
          ...
          <tr style={{borderBottom:'0.5px solid #575b63',height:'25px'}}>  
            <td style={{paddingLeft:'10px'}}colSpan={6}> <b>{details["IDType"] === 'passport' ? details["issueDate"] : ' '} </b></td>  
            <td colSpan={6}> <b>{details["IDType"] === 'passport' ? details["issuePlace"] :' '} </b></td>  
          </tr>
          <tr>  
          ...
          <br></br>
            ...
            <div style={{color:'black'}} >
            <div style={{paddingLeft:'10px', paddingRight:'5px'}}>
            <table  style={{border:'1px solid black','width':'202mm' ,height:'60mm',fontSize:'12px', color: 'black'}}>
            ...
            <tr>  
              ...
              <tr style={{borderBottom:'0.5px solid #575b63',height:'25px'}}>
                ...
                <tr>
                  <td colSpan={12} style={{fontSize:'7px', textAlign:'justify'}} > I agree to abide by the above terms and conditions governing my/our stay in the hotel:
               ...
               <tr>
                ...
                <td colSpan={4} style={{textAlign:'center' ,paddingRight: '120px'}} >Guest signature </td>
               </tr>
