...
const { data1: realData1, operation: realOperation } = data1;

  console.log("history", realData1);
  console.log("history", realData1.id);
  console.log(realOperation);
  ...
  useEffect(() => {
    let guestID = data1.data1.id;
    if(realOperation === 'reservationHistory') {
      guestID = data1.data1.guestID;
    }
    console.log("guestID", guestID);

    fetchx(API_URL + `/getGuestHistoryDetails?guestID=${guestID}&reservationStatus=Checked Out`)
  ...
  return (
    <div>
      ...
      {/* <div className="ag-theme-alpine" style={{ height: 0}}> */}
