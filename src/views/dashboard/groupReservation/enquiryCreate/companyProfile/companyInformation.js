      ...
      <div> <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className='d-flex justify-content-between'>
          <div className='d-flex'>
            <Button className='me-1' color='primary' type='submit' onClick={() => setflag(false)} disabled={isUpdated}>
              Save And Next
            </Button>
            <Button className="me-1" color="primary" type='submit' onClick={() => setflag(true)} disabled={isUpdated}>
              Create Company
            </Button>
