...
function App({data1}) {
  ...
  useEffect(() => {
fetchx(API_URL +`/getGuestForexDetails?hotelID=1&guestProfileID=${data1.guestProfileID}`)
  ...
  return(
    ...
    <div style={{width:'210mm',paddingTop:'10px'}}>
                <tr>
                  ...
                  <td style={{width:'280px' , verticalAlign: top}}>
                       <h5> <b> ENCASHMENT CERTIFICATE</b></h5>
                  </td>
    ...
    <p style={{fontSize:'9px', lineHeight:'1.5'}}> RBI Licence No: AD-Category II. No.01/2006   </p>
     ...
     <div class='row' style={{fontSize:'10px'}}>
        ...
        <div style={{paddingLeft:'70px'}}>
        <div class='row' style={{f7ntSize:'10px' ,width:650}}>
