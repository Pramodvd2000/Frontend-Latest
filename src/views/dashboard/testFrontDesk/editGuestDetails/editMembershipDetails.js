...
let navigate = useNavigate();
  ...
  const handleSuccess = (message) => {
    ...
    const onSubmit = data => {
        ...
        //     })
        // }
        const guestID = data3.data2.guestID;
        ...
        console.log("membershipSince:", membershipSince);
        console.log("membershipLevel:", membershipLevel);
    
        // Optional: Add actual validation check
        if (!guestID || !membershipType || !membershipNo || !nameOnCard || !membershipSince || !membershipLevel) {
          handleError("❌ Some required membership fields are missing!");
...
console.log(guestMembershipData[0].membershipSince)
        ...
        console.log("hi")
        let res = fetchx(API_URL + `/updatemembershipdetails?id=${data3.data2.guestID}`, {
            method: "PUT",
