...
// import Logo from '../theoterra.jpg';
  ...
  return(
    ...
    <div style={{width:'210mm',paddingTop:'10px'}}>
                <tr>
                  ...
                  {/* <font style={{ 'font-size': '12px', 'line-height': '100%' }}><b >THE OTERRA</b></font> */}
                  <font style={{ 'font-size': '14px', 'line-height': '100%', color: 'black'  }}><b >{hotelName}</b></font>
