...
const Floor = ({ stepper2, type, data1 }) => {
  ...
  // const [selectedValue, setSelectedValue] = useState(data3.data2.idDetails.IDType);
    // console.log(data3.data2.id)
...
console.log(localStorage.getItem("idDetails.IDType"));
  ...
  // const defaultReason = {
  //   value: data3.data2.idDetails.IDType,
  //   label: data3.data2.idDetails.IDType,
  // };

  // console.log(data3.data2)
  // console.log(data3.data2.idDetails.IDType)
  ...
  // console.log(data3.data2.guestID)
  // useEffect(() => {
  ...
  console.log(localStorage.getItem("id"));
  // console.log(data3.data2.idDetails.issuePlace);
                                ...
                                <div className="mb-1">
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => <Input placeholder='idNumber'
                                            ...
                                            title="ID Number can contain numbers . It cannnot contain alphabets and special characters." required
                                            invalid={errors.idNumber && true} {...field}
                                            // value={data3.data2.idDetails.idNumber} 
                                            />}
                                    />
                                </div>
                            </Col>
