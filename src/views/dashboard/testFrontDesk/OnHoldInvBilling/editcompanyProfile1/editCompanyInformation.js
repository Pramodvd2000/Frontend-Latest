...
const handleChange1 = (selectedOption1) => {
  ...
  const defaultReason1 = {
      value: data1 && data1.accountType,
      label: data1 && data1.accountType,    
    };
    ...
    const defaultReason2 = {
        ...
        label: data1 && data1.countriesName,    
      };
      ...
      const defaultReason3 = {
          value: data1 && data1.accountManagerID,
          label: data1 && data1.AccountAssociateName,    
        };
        ...
        const defaultReason4 = {
            value: data1 && data1.financialAssociateID,
            label: data1 && data1.financialAssociateName,    
          };
  ...
  const onSubmit = (data) => {
    ...
    if (data.accountType !== null && data.accountName !== null) {
      ...
      let createmarketGroup = JSON.stringify({
        ...
        "accountType": selectedValue1 === '' ? null :selectedValue1,
        "commision": data.commision1,
        "accountManagerID": selectedValue3 === '' ? null :selectedValue3,
        "email": data.emailBasic,
        "addressLine2": data.addressTwo2,
        "gstID": data.gst,
        "financialAssociateID": selectedValue4 === '' ? null :selectedValue4,
        "secondaryEmail": data.secondaryemail1,
        "country": selectedValue2 === '' ? null :selectedValue2,
        "isActive": 1,
        notes: data.notes1,
      ...
      console.log("hi");
      let res = fetchx(API_URL + `/updataccounts?companyid=${ data1.companyid}`, {
        method: "PUT",
