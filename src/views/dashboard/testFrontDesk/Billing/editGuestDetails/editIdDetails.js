...
console.log(localStorage.getItem("idDetails.IDType"));
  ...
  // const defaultReason = {
  //   value: data1.idDetails.IDType,
  //   label: data1.idDetails.IDType,
  // };
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    const actionButton1 = (rowval) => {
        ...
        console.log(createmarketGroup)
          console.log(data1)
        let res =    fetchx(API_URL + `/updateiddetails?guestID=${rowval.data.guestID}&id=${rowval.data.id}`, {
            method: 'PUT',
  ...
  // console.log(data1.guestID)

  // useEffect(() => {
  //   // if (data1 && data1.id) {
  //     fetchx(API_URL + `/getiddetails?guestID=31218`)
  ...
  console.log(localStorage.getItem("id"));
  // console.log(data1.idDetails.issuePlace);
