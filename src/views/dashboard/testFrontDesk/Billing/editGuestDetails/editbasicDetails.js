...
const Floor = ({ stepper2, type, data1 }) => {
  ...
  const [defaultReason3,setdefaultReason3] = useState({
    value: data1 &&  data1.companyID,
    label: data1 &&  data1.accountName,
  })
  ...
  const defaultReason = {
    value: data1 && data1.country,
    label: data1 && data1.countryName,
  };
  console.log(defaultReason);

  //Salutation
  const defaultReason1 = {
    value: data1 && data1.salutation,
    label: data1 && data1.salutation,
  };

  const defaultReason2 = {
    value:data1 &&  data1.nationality,
    label:data1 &&  data1.nationalityName,
  };

  const defaultReason4 = {
    value:data1 && data1.vipID,
    label:data1 && data1.vipType,
  };

  console.log(defaultReason4.value);
  ...
  const onSubmit = (data) => {
    ...
    if (data.firstName !== null && data.lastName !== null) {
      console.log(data.vipdata);
      let createmarketGroup = JSON.stringify({
        // id: data1.id,
        salutation:data.salu === undefined ? data1.salutation : data.salu.value,
        ...
        country: (data.countries === undefined)
        ? data1.country
        : (data.countries === null)
          ? null
      ...
      let res = fetchx(
        API_URL + `/updateguestprofile?id=${data1.id}`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
          ...
          <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            {data1&&  <Col md="3" sm="12">
             ...
             {data1 && <Col md="3" sm="12">
              ...
              {data1 && <Col md="3" sm="12" className="mb-1">
            <div className="mb-1">
              <Label className="form-label" for="vipdata">
              VIP Status<spam style={{ color: "red" }}>*</spam>
              </Label>
              <Controller
                id="vipdata"
                control={control}
            ...
            />
             ...
             {data1 &&  <Col md="5" sm="12" className="mb-1">
                <div className="mb-1">
                  <Controller
