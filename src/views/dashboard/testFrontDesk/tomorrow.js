...
import { Button, Modal, ModalBody, ModalHeader, Row, Col, Card, Label, Input, CardBody } from 'reactstrap';
...
function Tomorrow() {
  ...
  let Tomorrow;
  if (Today !== undefined) {
    Tomorrow = format(new Date(yesterday), "yyyy-MM-dd")
  }
...
useEffect(() => {
  ...
  useEffect(() => {
    fetchx(API_URL + '/getReservationForFrontDeskTomarrow?Start=' + Tomorrow)
      .then(result => result.json())
      .then(rowData => {
                ...
                <Row className='cardBody'>
                  ...
                  <Col md='2' sm='12' className='mb-1'>
                    ...
                    <div>
                      ...
                      }} className='hoverUnderline'>Begin CheckIn</div>
                      ...
                      {/* {filldata.isMain != 0 &&  */}
                      <div className='hoverUnderline' onClick={() => setCancelReservation(!cancelReservation)}>Cancel Reservation <br></br> / No Show</div>
                      {/* } */}
                      {/* <div
                        className="hoverUnderline">
