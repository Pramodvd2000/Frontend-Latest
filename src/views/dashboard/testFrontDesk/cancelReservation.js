...
const [Today, setToday] = useState()
  ...
  const getFinalInvoice = () => {
    ...
    fetchx(API_URL +'/getInvoiceJSON?hotelID=1&reservationID='+data1.id+'&folioNo=1')

    // fetchx('http://122.166.2.21:14780/getInvoiceJSON?hotelID=1&reservationID=' + data1.id + '&folioNo=1')
      .then(result => result.json())
      .then(rowData => {
        //console.log(rowData)
    ...
    <div>
          ...
          <Form onSubmit={handleSubmit(onSubmit)}>
            <Row>
              ...
              <Col md='3' sm='12' className='mb-1'>
                ...
                {data1.isMain === 1 && <div className='form-check form-check-inline'>
      ...
      >
        ...
        <ModalBody className='px-sm-5 mx-50 pb-5'>
          ...
          {ShowPaymentPreview && <>
            ...
            <h6>Guest Name : <b>{data1['firstName']}</b></h6>
            <h6> Ph No. :<b>{data1['phoneNumber']}</b></h6>
            <h6>Room No. : <b>{data1['room']}</b></h6>
      ...
      <div className='disabled-animation-modal'>
        <Modal isOpen={cancelSharer} toggle={() => setCancelSharer(!cancelSharer)} className='modal-dialog-centered'>
          ...
          <ModalBody className='px-5 pb-2'>
            <div className='text-center mb-2'>
              {data1.isMain === 0 && <h1 className='mb-1'>Only Sharer will get cancelled / No Show</h1>}
              {data1.isMain === 1 && <h1 className='mb-1'>Main Reservation along with Sharer will get cancelled / No Show</h1>}
              {/* <p>you want to submit this form ? </p> */}
            </div>
            <Col>
              <div className="button-container text-center">
                {data1.isMain === 1 && <Button className="me-1" color="primary" type="submit" onClick={handleSubmit(onSubmit)} >
                  Confirm
                </Button>}
                {data1.isMain === 0 && <Button className="me-1" color="primary" type="submit" onClick={onlySharerCancel} >
                  Confirm
                </Button>}
