...
const EditCheckOutAlert = (data1) => {
  ...
  const onSubmit = data => {
    ...
    // if ( data.checkInAlert !== null) {
      let createmarketGroup = JSON.stringify({
        ...
        "alertCode" : null, 
        "checkOutAlert": data.description,
             })
      let res = fetchx(API_URL+ `/updateCheckOutAlert` , {
        method: "PUT",
        ...
        if(res['status']==200){
          const swalInstance = MySwal.fire({
            text: 'CheckOut Alert edited Successfully!',
            icon: 'success',
  ...
  return (
    ...
    <div>     
        <Card>
      <CardHeader>
        <CardTitle tag='h4'>Edit CheckOut Alerts</CardTitle>
      </CardHeader>
      <CardBody>
...
export default EditCheckOutAlert;