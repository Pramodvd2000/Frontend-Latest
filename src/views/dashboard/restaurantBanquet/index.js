...
`;
    ...
    const onSubmit = (data) => {
        ...
        let res = fetchx(API_URL + "/createRestaurantBanquetBooking", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: createasset,
        }).then((res) => {
            ...
            if (res['status'] == 200) {
                ...
                fetchx(API_URL + "/getRestaurantBanquetBookingList", {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: unAssign,
                })
    ...
    function confirmCancel() {
        ...
        fetchx(API_URL + "/cancelRestaurantBanquetBooking", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: unAssign,
        })
        ...
        <div>
            <Card>
                ...
                <Accordion open={open} toggle={toggle}>
                    <AccordionItem>
                        <AccordionHeader targetId='1'><h4><b>Create Restaurant Banquet Booking</b></h4></AccordionHeader>
            ...
            <Card>
                <CardHeader>
                    <CardTitle tag="h4">All Restaurant Banquet Bookings</CardTitle>
                </CardHeader>
                <CardBody>
