...
const PillFilled = () => {
    ...
    const [active, setActive] = useState(sessionStorage.getItem('NightAuditTab') || undefined);
    ...
    const handleError = (message) => {
        ...
        // error handling for same guest addition
        const handleErrorRedirect = (message) => {
            return MySwal.fire({
                title: 'Error!',
                text: message,
                icon: 'error',
            ...
            .then(rowData => {
                ...
                if(rowData.statusCode === 403){
                    if(typeof (rowData.message) === 'string'){ 
                        ...
                        handleErrorRedirect(rowData.message)
                    }
                ...
                <Modal isOpen={rollOver} toggle={() => setRollOver(!rollOver)} className='modal-xm' centered>
                    ...
                    <ModalBody className='pb-3 px-sm-1 mx-20'>
                        {rollOver && rollOver.length != 0 && ((rollOver.arrivalDate !== rollOver.departureDate) ? (<div>
                            ...
                            <Col>
                                <div className="button-container text-center">
                                    <Button className="me-1" color="primary" type="submit" onClick={() => RollOverApi()} >
                                        Confirm
                                    </Button>
                    ...
                    <div className="bg-white min-vh-100 d-flex justify-content-center align-items-center" style={{ marginTop: '-160px' }}>
                        ...
                        <Card className="w-50 text-center p-4 shadow-lg rounded">
                            <CardBody>
                                ...
                                <div>
                                    <Button color="primary" onClick={generateReports}>
                                        Generate reports
                                    </Button>{' '}
                                </div>
                            </CardBody>
