...
const Floor = ({ stepper2, type, data3 }) => {
  ...
  // const [selectedValue, setSelectedValue] = useState(data3.data1.idDetails.IDType);
...
console.log(localStorage.getItem("idDetails.IDType"));
  ...
  // const defaultReason = {
  //   value: data3.data1.idDetails.IDType,
  //   label: data3.data1.idDetails.IDType,
  // };

  // console.log(data3.data1)
  // console.log(data3.data1.idDetails.IDType)
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    const actionButton1 = (rowval) => {
        ...
        console.log(createmarketGroup)
          console.log(data3.data1)
        let res =    fetchx(API_URL + `/updateiddetails?guestID=${rowval.data.id}&id=${rowval.data.id}`, {
            method: 'PUT',
  ...
  console.log(data3.data1.id)
  useEffect(() => {
    fetchx(API_URL + `/getiddetails?guestID=${data3.data1.id}`)
  ...
  console.log(localStorage.getItem("id"));
  // console.log(data3.data1.idDetails.issuePlace);
                                ...
                                <div className="mb-1">
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => <Input placeholder='idNumber'
                                            ...
                                            title="ID Number can contain numbers . It cannnot contain alphabets and special characters." required
                                            invalid={errors.idNumber && true} {...field}
                                            // value={data3.data1.idDetails.idNumber} 
                                            />}
                                    />
                                </div>
                            </Col>
                            ...
                            <Col md='4' sm='12' className='mb-1'>
                                <div className='mb-1'>
                                    ...
                                    <Controller
                                        ...
                                        {...field} 
                                        // value={data3.data1.idDetails.name} 
                                        />}
                                    />
                                </div>
                            </Col>
