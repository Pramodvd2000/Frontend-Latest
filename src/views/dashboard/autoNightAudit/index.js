...
const PillFilled = () => {
                ...
                .then(rowData2 => {
                    ...
                    if (rowData2.statusCode === 200) {
                        ...
                        if (rowData2.data.length !== 0) {
                            ...
                            if (rowData2.data[0]['unSettleBills'] === '0') {
                                setActive('4')
                            ...
                            else if (rowData2.data[0]['countryAndStateCheck'] === '0') {
                                setActive('1')
                                setDisableRoomPosting(true)
                                setDisableFixedPosting(true)
                                setDisableRoomStatus(true)
    ...
    // async function CheckPendingSteps(step) {
    ...
    // async function CheckPendingSteps(step) {
    //     let unAssign = JSON.stringify({ step: step });

    //     return fetchx(API_URL + "/nightAuditStepCheck", {
    //         method: "POST",
    //         headers: { "Content-Type": "application/json" },
    //         body: unAssign,
    //     })
    ...
    async function CheckPendingSteps(step) {
        ...
        try {
            const result = await fetchx(API_URL + "/nightAuditStepCheck", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: unAssign,
            });
            ...
            if (rowData.statusCode === 200) {
                ...
                await RefreshGetNightAuditFunction(); // Wait for this to complete
                handleError(rowData.message);
                return false;
            }
